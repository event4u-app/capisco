...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-actually-works.md](roadmaps/road-to-actually-works.md) | 9 | 55 | 16 | 39 | 0 | 0 | ███████░░░ 71% |
...
| 7 | [road-to-sentry-observability.md](roadmaps/road-to-sentry-observability.md) | 5 | 30 | 17 | 13 | 0 | 0 | ████░░░░░░ 43% |
...
**Road to Actually Works — die Spine zur gefühlten IDE** — 39 / 55 done (71%)
...
| 2 | Echter Agent end-to-end, IM BROWSER bewiesen (gefühlte Scheibe #1) | 🟡 in progress | 1 | 8 | 0 | 0 | 89% |
...
**Road to Agent-Matrix & Ambient — das Hirn und die Nachtschicht** — 8 / 39 done (21%)
...
**Road to Desktop-Release — verteilbare, signierte Capisco-Builds** — 0 / 14 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | `tauri build` + Sidecar-Packaging (lokal reproduzierbar) | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
| 1 | Versioning (eine Quelle der Wahrheit) | ⬜ not started | 2 | 0 | 0 | 0 | 0% |
| 2 | Code-Signing / Notarisierung (Cert-gated, Klasse-C) | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
| 3 | CI-Release-Workflow (tag-getriggert, matrix) | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
...
**Road to Real Runtime — mächtiges Coden (Container · Debug · Quality · LSP · Recovery)** — 25 / 29 done (86%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | Worktree-Runtime + Container (Docker · Devcontainer · Traefik · ctop) | 🟡 in progress | 1 | 8 | 0 | 0 | 89% |
| 1 | Debugging (DAP / xdebug) | ✅ done | 0 | 6 | 0 | 0 | 100% |
| 2 | Quality real (Grounding) + Model-Routing-Signal | 🟡 in progress | 3 | 2 | 0 | 0 | 40% |
| 3 | Advanced-LSP (Navigation jenseits Autocomplete) | ✅ done | 0 | 4 | 0 | 0 | 100% |
| 4 | Crash- & State-Recovery | ✅ done | 0 | 5 | 0 | 0 | 100% |

### [road-to-sentry-observability.md](roadmaps/road-to-sentry-observability.md)

**Road to Sentry Observability — die Sentry-Ansicht (4 Tabs, 1:1 ans Design)** — 13 / 30 done (43%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | Contract + Fixture + Design 1:1 portiert (autonom-grün) | ✅ done | 0 | 8 | 0 | 0 | 100% |
| 1 | ProviderAuth + Real-Read (Token-first) + Kill-Switch | 🟡 in progress | 3 | 5 | 0 | 0 | 63% |
...
**Road to: Shell & Chat really work** — 21 / 25 done (84%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | Native-Fenster-Shell (Tauri-ACL)  [nativ-verifiziert] | 🟡 in progress | 1 | 4 | 0 | 0 | 80% |
| 1 | Echte Backend-Auswahl (detect → Katalog → select → Redetect/Save) | ✅ done | 0 | 7 | 0 | 0 | 100% |
| 2 | Send-Loop-Ehrlichkeit (kein Fake-Endlos-Spinner) | ✅ done | 0 | 4 | 0 | 0 | 100% |
| 3 | Per-Session-Backend + Mid-Chat-Agent/CLI-Wechsel | 🟡 in progress | 2 | 4 | 0 | 0 | 67% |
| 4 | Chat-Kind-Ehrlichkeit | ⬜ not started | 1 | 0 | 0 | 0 | 0% |
| 5 | Browser-Mock streamt eine echte Antwort (Dev/Demo-Erlebnis) | ✅ done | 0 | 2 | 0 | 0 | 100% |
